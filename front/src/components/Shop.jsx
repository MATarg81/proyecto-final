      ...
      <>
        ...
        <div class="row align-items-center py-3 px-xl-5">
          <div class="col-lg-3 d-none d-lg-block">
            <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-1 mr-1">T</span>ienda</h1>
          </div>
          ...
          <div class="col-lg-3 col-6 text-right">
            ...
            <span class="badge text-dark">({fav_state.fav?.length})</span>
          ...
          {productsPage?.map((p) => (
            <div class="card product-item border-0" key={p.id}>
              ...
              <div class="card-footer d-flex justify-content-between bg-light border">
                <a onClick={() => navigate(`/tienda/${p.id}`)} class="btn btn-sm text-dark p-0">
                  <i>
                ...
                <a onClick={() => addProduct(p)} class="btn btn-sm text-dark p-0">
                  <i >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
                      <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z" />
                    </svg>
                  </i>Agregar al carrito</a>
                <a onClick={() => handleAddtoFav(p.id)} class="btn btn-sm text-dark p-0">
                  <i >
