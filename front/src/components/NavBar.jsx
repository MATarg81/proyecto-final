    ...
    <div>
      ...
      <nav class="navbar navbar-expand-sm navbar-light">
        <div class="container">
          ...
          <a class="btn text-white" style={{ backgroundColor: "#3b5998" }} href="#!" role="button">
            <i class="">
          ...
          <a class="btn text-white" style={{ backgroundColor: "#ac2bac" }} href="#!" role="button">
            <i class="">
          ...
          <a class="btn text-white" style={{ backgroundColor: "#ed302f" }} href="#!" role="button">
            <i class="">
          ...
          <div id="navbarNav">
            <ul class="navbar-nav ml-lg-auto">
              <div class="ml-lg-4">
                ...
                <Link to="/carrito" className="btn btn-outline-secondary ms-2">
